...
/* prcm */
#define R_PRCM_CLK_GATING_REG       (R_PRCM_BASE + 0x28) // APB0_GATING_REG
#define R_PIO_GATING                BIT(0)
#define R_PRCM_CPU_PWROFF           (R_PRCM_BASE + 0x100)
#define R_PRCM_VDD_SYS_PWROFF       (R_PRCM_BASE + 0x110)
#define R_PRCM_GPU_PWROFF           (R_PRCM_BASE + 0x118)
#define R_PRCM_CPU_PWR_CLAMP        (R_PRCM_BASE + 0x140)

/* CPU config */
#define R_CPUCFG_RST_CPU_BASE       (R_CPUCFG_BASE + 0x040)
#define R_CPUCFG_DBG_CTRL1          (R_CPUCFG_BASE + 0x1e4)
